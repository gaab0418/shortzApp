...
exports.addComment = async (req, res) => {
  ...
  try {
    ...
    res.status(error.message === "O comentário não pode ser vazio." ? 400 : 500).json({
...
exports.getComments = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ message: error.message || "Erro interno do servidor ao buscar comentários." });
  }
};
